...
public class Application1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < str1.length(); i++) {        // 0 ~ 4         // String의 길이를 아는 length()는 메소드여서 ()필요
            System.out.println("charAt(" + i + ") = " + str1.charAt(i));  // charAt()는 char배열을 다룸
        }

        /* 필기. compareTo(): 인자로 전달된 문자열과 사전 순(한글자씩 비교 후 넘기기)으로 비교 */
        String str2 = "java";
        String str3 = "java";
        String str4 = "JAVA";
        String str5 = "mariaDB";
        ...
        /* 필기. indexOf(): 문자열에서 특정 문자를 탐색하여 처음 일치하는 인덱스 위치를 정수형로 반환/ 없으면 -1 반환  */
        ...
        */
        ...
        System.out.println("substring(3,6): " + javamariaDB.substring(3,6));                // 3 ~ 5
        ...
        /* 필기. isEmpty(): 문자열의 길이가 0이면 true를 반환, 아니면 false를 반환(null과 다르다. - 빈 문자열 "") */
