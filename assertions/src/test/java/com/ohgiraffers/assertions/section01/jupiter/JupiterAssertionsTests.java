...
/* 목차. 1. assertEquals */
/* 필기. assertEquals(expected, actual) 메소드는 실제값과 일치 여부를 동일성으로 판단한다. */
...
//        Assertions.assertEquals(expected, result, 1);       // 오차범위에 해당하는 매개변수도 제공
    ...
    void testAssertThrows() {
        ...
        Exception excpetion = Assertions.assertThrows(
