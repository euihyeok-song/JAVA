...
public class Application3 {
    public static void main(String[] args) {
        ...
        */
        List<Member> memberList = Arrays.asList(                  // new ArrayList 의 대안 방안
        ...
        List<String> collectorCollection = memberList.stream()
                                                    .map(Member::getMemberName)  //memberName으로 새로운 Stream을 만들어준다.
        ...
        String str2 = memberList.stream()
                .map(Member::getMemberName)
                .collect(Collectors.joining("||", "**","!!"));     // 구분자를 넣어서 합칠수 있다.
