...
public class MemberService {
    ...
    /* 설명. 회원 가입을 5명 진행하고 저장하기 위해 저장용 객체(Register)에게 호출 - controller 개념*/
    public void signUpMembers() {
        ...
        members[3] = new Member(4,"user04","pass04","심사임당",36,'여');
        members[4] = new Member(5,"user05","pass05","윤봉길",22,'남');

        MemberRegister memberRegister = new MemberRegister();       // 회원을 잘 등록해주는 클래스
        memberRegister.regist(members);
    }

    public void showAllMembers() {

        MemberFinder finder = new MemberFinder();           // 회원을 잘 찾아주는 클래스
