package com.ohigraffers.section01.intenum;
...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명. 1. 두 과목의 명은 다르지만, 코드에서는 둘다 같은 상수이자 숫자 0일 뿐  구분할 수 없어 동일한 것으로 인지함(런타임 시점) */
        ...
        /* 설명. 5. 타입 안전성을 보장할 수 없다. - 아래 2개의 코드가 동일함 ( 타입 안전성 보장 X) */
        printSubject(Subjects.JAVA);
        printSubject(0);                // 과목 없이 그냥 숫자의 개념도 허용이 된다. (타입 안전성 보장 X)

    }

    /* 설명. 매개변수의 의미는 단순히 정수가 넘어온다 밖에 없다. (Subject라는 개념이 문법적으로 적용되지 X) */
