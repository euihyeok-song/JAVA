...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseStatement(){
        ...
        System.out.println("나무꾼에게 셋 중 어떤 도끼가 나무꾼의 도끼인지 물어보았디.");

        System.out.print("어떤 도끼가 너의 도끼이냐? (1.금도끼, 2.은도끼, 3.쇠도끼): ");
    ...
    public void testNestedIfElseIfStatement(){
        ...
        *   60점 미만인 경우에는 'F'를 학점을 주게 된다.
        *   그래서 학생의 이름과 점수를 입력하면 자동으로 학점 등급이 계싼되는  프로그램을 만들기로 했다.
